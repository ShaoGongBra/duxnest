...
export class ExpressLoader extends AbstractLoader {
  public register(httpAdapter: AbstractHttpAdapter, optionsArr: ServeStaticModuleOptions[]) {
    const app = httpAdapter.getInstance()
    const express = loadPackage('express', 'ServeStaticModule', () => require('express'))
    optionsArr.forEach(options => {
      ...
      const renderFn = (req: unknown, res: any, next: () => void) => {
